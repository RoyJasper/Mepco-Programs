     ...
     while(1)    
   {
          ...
          switch(cho)        
    {
               ...
               if(fou==0)            
     {
               ...
               fclose(fp);
               break;
           case 5:jas:            fp=fopen("sym.bin","ab+");
               if (!fp)            
     {
                    printf("\nUnable to open file!");
                    return -1;
